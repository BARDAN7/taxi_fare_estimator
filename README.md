...
2. Real-Time Input:
Allows users to enter trip details (e.g., distance, duration, time of day) interactively through an easy-to-use interface.

3. Machine Learning Integration:
Uses a trained ML model to predict fares based on historical trip data for better accuracy and dynamic pricing.
